<?php 
    ...
    if(isset($_POST["submit"])){
        $resultAdd = addingDataBooks($_POST, $_FILES);
        
        // cek in
        if($resultAdd > 0){
            echo "
                <script>
                    alert('Success Adding New Books :)');
  ...
  <body>
    ...
    <div class="container">
        <div class="content-form mt-5 w-75">
            <h2 class="font-weight-bold mb-4">Form Adding Book</h2>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="genre" placeholder="genre..." required>
                </div>

                <div class="form-group">
                    <label for="exampleInputPassword1">Creator Book</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" name="creator" placeholder="creator..." required>
                </div>

                <div class="form-group">
                    <label for="exampleInputPassword1">Name Book</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" name="nameBook" placeholder="name..." required>
                </div>
